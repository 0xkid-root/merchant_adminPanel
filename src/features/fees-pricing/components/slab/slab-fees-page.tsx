...
export function SlabFeesPage() {
  const { data: fees, isLoading } = useFees("SLAB_BASED");
            ...
            {isLoading ? (
              ...
              filteredFees?.map((item) => (
                <TableRow key={item.id}>
                  ...
                  <TableCell>
                    <Link href={`/fees-pricing/slab/${item.id}`} className="text-primary hover:underline">
                    ...
                    <DropdownMenu>
                      ...
                      <DropdownMenuContent align="end">
                        <DropdownMenuItem asChild>
                          <Link href={`/fees-pricing/slab/${item.id}`}>View / Edit</Link>
                        </DropdownMenuItem>
                        <DropdownMenuItem>
