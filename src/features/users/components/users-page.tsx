...
const MOCK_USERS = [
  { id: "U-001", name: "Alice Admin", email: "alice@atmoonpe.com", role: "SUPER_ADMIN", status: "ACTIVE", lastLogin: "10 mins ago" },
  { id: "U-002", name: "Bob Operations", email: "bob@atmoonpe.com", role: "OPERATIONS_ADMIN", status: "ACTIVE", lastLogin: "1 hour ago" },
  { id: "U-003", name: "Charlie Finance", email: "charlie@atmoonpe.com", role: "FINANCE_ADMIN", status: "ACTIVE", lastLogin: "Yesterday" },
  { id: "U-004", name: "David Support", email: "david@atmoonpe.com", role: "SUPPORT_ADMIN", status: "SUSPENDED", lastLogin: "1 month ago" },
];
