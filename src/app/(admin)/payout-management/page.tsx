...
import { PayoutTable } from "@/features/payout/components/payout-table";
import { PayoutFilters } from "@/features/payout/components/payout-filters";
import { usePayoutsQuery } from "@/features/payout/hooks/use-payouts";
import { useTableState } from "@/hooks/use-table-state";
import { Button } from "@/components/ui/button";
import { RefreshCw, Download } from "lucide-react";
import { PayoutStatus, PayoutMethod } from "@/features/payout/types/payout.types";
      ...
      <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4">
        <div>
          ...
          <p className="text-sm text-slate-500 mt-1">
            Monitor, review, and manage merchant payout activity across the platform.
          </p>
        </div>
